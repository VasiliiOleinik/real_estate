...
const NoData = () => {
  return (
    <div className="overflow-hidden border border-gray-200 dark:border-white rounded-xl bg-white text-gray-700 shadow-md dark:shadow-dark p-10">
      <div className="w-full flex items-center mx-auto py-12">
        <svg
          className="w-10 h-10 text-gray-80"
          aria-hidden="true"
      ...
      <p className="text-gray-700 font-medium text-lg text-center">
        Sorry, we didn't find any real estate ! :(
      </p>
